...
public class ServletOperaciones extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		//float txtNumber1 = request.getParameter("txtNumber1");
		//float txtNumber2 = request.getParameter("txtNumber2");
		
		//PrintWriter writer = response.getWriter();
		//writer.append(index.jsp);
		OperacionesMatematias cuentitas;
		cuentitas = new OperacionesMatematias();
		...
		{
			response.sendRedirect("menor10.jsp");
		}
		if(cuentitas.sumar()>=0 && cuentitas.sumar()<=10.0);
		{
			response.sendRedirect("calif.jsp");
		}
	}
